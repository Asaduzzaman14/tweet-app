            ...
            <div className="card w-96 bg-base-100 shadow-lg">
                <div className="card-body ">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-control w-full max-w-xs">
                            ...
                            <div className='input-group'>
                                ...
                                <span
                                    onClick={() => {
                                        setShow(!show);
                                        setPasswordVisivility(!passwordVisivility)
                                    }
                                    }
                                    className='cursor-pointer'
                                > {show ? <AiTwotoneEyeInvisible /> : <FaEye />} </span>
                            </div>
                        ...
                        <Link to='/register'><small>New To Tweet App ? <span className='text-primary font-mono hover:underline'>Create an account</span></small></Link>
                        <br />
